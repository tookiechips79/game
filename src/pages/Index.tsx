...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (newBookedCount > prevBookedCount) {
      console.log(`🔊 [MATCH SOUND] Bets matched! New booked count: ${newBookedCount}`);
  ...
  useEffect(() => {
    ...
    if (newNextGameBetCount > prevNextGameBetCount) {
      console.log(`🔊 [NEXT GAME BET SOUND] Next game bet placed! New count: ${newNextGameBetCount}`);
      playSilverSound();
    }
